...
<bignumber>`r prettyNum(round(assaults_city$avg_prior4years,0), big.mark=",")`<br></bignumber><p>
...
<bignumber>`r prettyNum(round(assaults_city$rate_prior4years,0), big.mark=",")`<br></bignumber><p>
Per 100,000 people<br>2020 to 2023</p>
</div>
</div>
<br>
Aggravated assaults over the last 12 months are <h8>`r ifelse(assaults_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(assaults_city$inc_prior4yearavgtolast12>=0,assaults_city$inc_prior4yearavgtolast12,substring(assaults_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to the San Francisco Police Department data through `r format(asofdate, "%B %d")`.

The city averaged <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> aggravated assaults a week over the last 12 months. In 2020, that number was <h8>`r prettyNum(round(assaults_city$total20/52,0), big.mark=",")`</h8> a week.
...
The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's data by neighborhood from 2020 through `r format(asofdate, "%B %d, %Y")`.
...
"</td>
				...
				<td>",
round(assaults_district$avg_prior4years,0),
"</td>
				<td>",
prettyNum(round(assaults_district$rate_prior4years,0), big.mark=","),
"</td>
			</tr>
</table>")
...
<br>
<br>
<iframe title="Aggravated assault clearance rate year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-oDFUH" src="https://datawrapper.dwcdn.net/oDFUH/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="538" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
