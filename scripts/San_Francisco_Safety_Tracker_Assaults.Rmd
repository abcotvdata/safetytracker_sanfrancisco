...
The city averaged <h8>`r prettyNum(round(assaults_city$last12mos/52,0), big.mark=",")`</h8> aggravated assaults a week over the last 12 months. In 2021, that number was <h8>`r prettyNum(round(assaults_city$total20/52,0), big.mark=",")`</h8> a week.
...
The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's data by neighborhood from 2021 through `r format(asofdate, "%B %d, %Y")`.
