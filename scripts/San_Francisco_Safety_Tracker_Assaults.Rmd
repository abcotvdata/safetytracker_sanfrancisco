...
<subhead>A closer look at San Francisco assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
san_francisco_assault_map <- leaflet(assaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<!-- <subhead>Risk of assault and other violent crimes in San Francisco </subhead> -->
