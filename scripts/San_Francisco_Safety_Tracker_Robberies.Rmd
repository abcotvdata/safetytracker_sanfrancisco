...
<bignumber>`r prettyNum(round(robberies_city$avg_prior4years,0), big.mark=",")`<br></bignumber><p>
...
<bignumber>`r round(robberies_city$rate_prior4years,0)`<br></bignumber><p>
Per 100,000 people<br>2020 to 2023</p>
</div>
</div>
<br>
Robberies over the last 12 months are <h8>`r ifelse(robberies_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(robberies_city$inc_prior4yearavgtolast12>=0,robberies_city$inc_prior4yearavgtolast12,substring(robberies_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.

The city averaged <h8>`r round(robberies_city$last12mos/52,0)`</h8> robberies a week over the last 12 months. In 2020, that number was <h8>`r round(robberies_city$total20/52,0)`</h8> a week.
...
"</td>
				...
				<td>",
round(robberies_district$avg_prior4years,0),
"</td>
				<td>",
round(robberies_district$rate_prior4years,0),
"</td>
			</tr>
</table>")
...
<iframe title="Robberies year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-KLf8r" src="https://datawrapper.dwcdn.net/KLf8r/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<iframe title="Robbery clearance rate year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-BDuad" src="https://datawrapper.dwcdn.net/BDuad/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="538" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
