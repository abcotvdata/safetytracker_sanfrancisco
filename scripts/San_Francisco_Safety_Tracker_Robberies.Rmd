...
<subhead>A closer look at San Francisco robberies neighborhood by neighborhood</subhead>
...
san_francisco_robbery_map <- leaflet(robberies_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
