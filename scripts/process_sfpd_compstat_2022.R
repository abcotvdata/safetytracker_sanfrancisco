...
# Grab individual text values for Page 1
rawtext1 <- pdftext[[13]][1] %>% trimws()
rawtext2 <- pdftext[[13]][2] %>% trimws()
rawtext3 <- pdftext[[13]][3] %>% trimws()
rawtext4 <- pdftext[[13]][4] %>% trimws()
rawtext5 <- pdftext[[13]][5] %>% trimws()
rawtext6 <- pdftext[[13]][6] %>% trimws()
rawtext7 <- pdftext[[13]][7] %>% trimws()
rawtext8 <- pdftext[[13]][8] %>% trimws()
rawtext9 <- pdftext[[13]][9] %>% trimws()
rawtext10 <- pdftext[[13]][10] %>% trimws()
rawtext11 <- pdftext[[13]][11] %>% trimws()
rawtext12 <- pdftext[[13]][12] %>% trimws()
rawtext13 <- pdftext[[13]][13] %>% trimws()
rawtext14 <- pdftext[[13]][14] %>% trimws()
rawtext15 <- pdftext[[13]][15] %>% trimws()
rawtext16 <- pdftext[[13]][16] %>% trimws()
rawtext17 <- pdftext[[13]][17] %>% trimws()
rawtext18 <- pdftext[[13]][18] %>% trimws()
rawtext19 <- pdftext[[13]][19] %>% trimws()
rawtext20 <- pdftext[[13]][20] %>% trimws()
rawtext21 <- pdftext[[13]][21] %>% trimws()
rawtext22 <- pdftext[[13]][22] %>% trimws()
rawtext23 <- pdftext[[13]][23] %>% trimws()
rawtext24 <- pdftext[[13]][24] %>% trimws()
rawtext25 <- pdftext[[13]][25] %>% trimws()
rawtext26 <- pdftext[[13]][26] %>% trimws()
rawtext27 <- pdftext[[13]][27] %>% trimws()
rawtext28 <- pdftext[[13]][28] %>% trimws()
rawtext29 <- pdftext[[13]][29] %>% trimws()
rawtext30 <- pdftext[[13]][30] %>% trimws()
rawtext31 <- pdftext[[13]][31] %>% trimws()
rawtext32 <- pdftext[[13]][32] %>% trimws()
rawtext33 <- pdftext[[13]][33] %>% trimws()
rawtext34 <- pdftext[[13]][34] %>% trimws()
rawtext35 <- pdftext[[13]][35] %>% trimws()
rawtext36 <- pdftext[[13]][36] %>% trimws()
rawtext37 <- pdftext[[13]][37] %>% trimws()
rawtext38 <- pdftext[[13]][38] %>% trimws()
rawtext39 <- pdftext[[13]][39] %>% trimws()
rawtext40 <- pdftext[[13]][40] %>% trimws()
rawtext41 <- pdftext[[13]][41] %>% trimws()
rawtext42 <- pdftext[[13]][42] %>% trimws()
rawtext43 <- pdftext[[13]][43] %>% trimws()
rawtext44 <- pdftext[[13]][44] %>% trimws()
rawtext45 <- pdftext[[13]][45] %>% trimws()
rawtext46 <- pdftext[[13]][46] %>% trimws()
rawtext47 <- pdftext[[13]][47] %>% trimws()
rawtext48 <- pdftext[[13]][48] %>% trimws()
rawtext49 <- pdftext[[13]][49] %>% trimws()
rawtext50 <- pdftext[[13]][50] %>% trimws()
...
# Grab individual text values for Page 1
rawtext1 <- pdftext[[15]][1] %>% trimws()
rawtext2 <- pdftext[[15]][2] %>% trimws()
rawtext3 <- pdftext[[15]][3] %>% trimws()
rawtext4 <- pdftext[[15]][4] %>% trimws()
rawtext5 <- pdftext[[15]][5] %>% trimws()
rawtext6 <- pdftext[[15]][6] %>% trimws()
rawtext7 <- pdftext[[15]][7] %>% trimws()
rawtext8 <- pdftext[[15]][8] %>% trimws()
rawtext9 <- pdftext[[15]][9] %>% trimws()
rawtext10 <- pdftext[[15]][10] %>% trimws()
rawtext11 <- pdftext[[15]][11] %>% trimws()
rawtext12 <- pdftext[[15]][12] %>% trimws()
rawtext13 <- pdftext[[15]][13] %>% trimws()
rawtext14 <- pdftext[[15]][14] %>% trimws()
rawtext15 <- pdftext[[15]][15] %>% trimws()
rawtext16 <- pdftext[[15]][16] %>% trimws()
rawtext17 <- pdftext[[15]][17] %>% trimws()
rawtext18 <- pdftext[[15]][18] %>% trimws()
rawtext19 <- pdftext[[15]][19] %>% trimws()
rawtext20 <- pdftext[[15]][20] %>% trimws()
rawtext21 <- pdftext[[15]][21] %>% trimws()
rawtext22 <- pdftext[[15]][22] %>% trimws()
rawtext23 <- pdftext[[15]][23] %>% trimws()
rawtext24 <- pdftext[[15]][24] %>% trimws()
rawtext25 <- pdftext[[15]][25] %>% trimws()
rawtext26 <- pdftext[[15]][26] %>% trimws()
rawtext27 <- pdftext[[15]][27] %>% trimws()
rawtext28 <- pdftext[[15]][28] %>% trimws()
rawtext29 <- pdftext[[15]][29] %>% trimws()
rawtext30 <- pdftext[[15]][30] %>% trimws()
rawtext31 <- pdftext[[15]][31] %>% trimws()
rawtext32 <- pdftext[[15]][32] %>% trimws()
rawtext33 <- pdftext[[15]][33] %>% trimws()
rawtext34 <- pdftext[[15]][34] %>% trimws()
rawtext35 <- pdftext[[15]][35] %>% trimws()
rawtext36 <- pdftext[[15]][36] %>% trimws()
rawtext37 <- pdftext[[15]][37] %>% trimws()
rawtext38 <- pdftext[[15]][38] %>% trimws()
rawtext39 <- pdftext[[15]][39] %>% trimws()
rawtext40 <- pdftext[[15]][40] %>% trimws()
rawtext41 <- pdftext[[15]][41] %>% trimws()
rawtext42 <- pdftext[[15]][42] %>% trimws()
rawtext43 <- pdftext[[15]][43] %>% trimws()
rawtext44 <- pdftext[[15]][44] %>% trimws()
rawtext45 <- pdftext[[15]][45] %>% trimws()
rawtext46 <- pdftext[[15]][46] %>% trimws()
rawtext47 <- pdftext[[15]][47] %>% trimws()
rawtext48 <- pdftext[[15]][48] %>% trimws()
rawtext49 <- pdftext[[15]][49] %>% trimws()
rawtext50 <- pdftext[[15]][50] %>% trimws()
...
# Grab individual text values for Page 1
rawtext1 <- pdftext[[17]][1] %>% trimws()
rawtext2 <- pdftext[[17]][2] %>% trimws()
rawtext3 <- pdftext[[17]][3] %>% trimws()
rawtext4 <- pdftext[[17]][4] %>% trimws()
rawtext5 <- pdftext[[17]][5] %>% trimws()
rawtext6 <- pdftext[[17]][6] %>% trimws()
rawtext7 <- pdftext[[17]][7] %>% trimws()
rawtext8 <- pdftext[[17]][8] %>% trimws()
rawtext9 <- pdftext[[17]][9] %>% trimws()
rawtext10 <- pdftext[[17]][10] %>% trimws()
rawtext11 <- pdftext[[17]][11] %>% trimws()
rawtext12 <- pdftext[[17]][12] %>% trimws()
rawtext13 <- pdftext[[17]][13] %>% trimws()
rawtext14 <- pdftext[[17]][14] %>% trimws()
rawtext15 <- pdftext[[17]][15] %>% trimws()
rawtext16 <- pdftext[[17]][16] %>% trimws()
rawtext17 <- pdftext[[17]][17] %>% trimws()
rawtext18 <- pdftext[[17]][18] %>% trimws()
rawtext19 <- pdftext[[17]][19] %>% trimws()
rawtext20 <- pdftext[[17]][20] %>% trimws()
rawtext21 <- pdftext[[17]][21] %>% trimws()
rawtext22 <- pdftext[[17]][22] %>% trimws()
rawtext23 <- pdftext[[17]][23] %>% trimws()
rawtext24 <- pdftext[[17]][24] %>% trimws()
rawtext25 <- pdftext[[17]][25] %>% trimws()
rawtext26 <- pdftext[[17]][26] %>% trimws()
rawtext27 <- pdftext[[17]][27] %>% trimws()
rawtext28 <- pdftext[[17]][28] %>% trimws()
rawtext29 <- pdftext[[17]][29] %>% trimws()
rawtext30 <- pdftext[[17]][30] %>% trimws()
rawtext31 <- pdftext[[17]][31] %>% trimws()
rawtext32 <- pdftext[[17]][32] %>% trimws()
rawtext33 <- pdftext[[17]][33] %>% trimws()
rawtext34 <- pdftext[[17]][34] %>% trimws()
rawtext35 <- pdftext[[17]][35] %>% trimws()
rawtext36 <- pdftext[[17]][36] %>% trimws()
rawtext37 <- pdftext[[17]][37] %>% trimws()
rawtext38 <- pdftext[[17]][38] %>% trimws()
rawtext39 <- pdftext[[17]][39] %>% trimws()
rawtext40 <- pdftext[[17]][40] %>% trimws()
rawtext41 <- pdftext[[17]][41] %>% trimws()
rawtext42 <- pdftext[[17]][42] %>% trimws()
rawtext43 <- pdftext[[17]][43] %>% trimws()
rawtext44 <- pdftext[[17]][44] %>% trimws()
rawtext45 <- pdftext[[17]][45] %>% trimws()
rawtext46 <- pdftext[[17]][46] %>% trimws()
rawtext47 <- pdftext[[17]][47] %>% trimws()
rawtext48 <- pdftext[[17]][48] %>% trimws()
rawtext49 <- pdftext[[17]][49] %>% trimws()
rawtext50 <- pdftext[[17]][50] %>% trimws()
...
# Grab individual text values for Page 1
rawtext1 <- pdftext[[19]][1] %>% trimws()
rawtext2 <- pdftext[[19]][2] %>% trimws()
rawtext3 <- pdftext[[19]][3] %>% trimws()
rawtext4 <- pdftext[[19]][4] %>% trimws()
rawtext5 <- pdftext[[19]][5] %>% trimws()
rawtext6 <- pdftext[[19]][6] %>% trimws()
rawtext7 <- pdftext[[19]][7] %>% trimws()
rawtext8 <- pdftext[[19]][8] %>% trimws()
rawtext9 <- pdftext[[19]][9] %>% trimws()
rawtext10 <- pdftext[[19]][10] %>% trimws()
rawtext11 <- pdftext[[19]][11] %>% trimws()
rawtext12 <- pdftext[[19]][12] %>% trimws()
rawtext13 <- pdftext[[19]][13] %>% trimws()
rawtext14 <- pdftext[[19]][14] %>% trimws()
rawtext15 <- pdftext[[19]][15] %>% trimws()
rawtext16 <- pdftext[[19]][16] %>% trimws()
rawtext17 <- pdftext[[19]][17] %>% trimws()
rawtext18 <- pdftext[[19]][18] %>% trimws()
rawtext19 <- pdftext[[19]][19] %>% trimws()
rawtext20 <- pdftext[[19]][20] %>% trimws()
rawtext21 <- pdftext[[19]][21] %>% trimws()
rawtext22 <- pdftext[[19]][22] %>% trimws()
rawtext23 <- pdftext[[19]][23] %>% trimws()
rawtext24 <- pdftext[[19]][24] %>% trimws()
rawtext25 <- pdftext[[19]][25] %>% trimws()
rawtext26 <- pdftext[[19]][26] %>% trimws()
rawtext27 <- pdftext[[19]][27] %>% trimws()
rawtext28 <- pdftext[[19]][28] %>% trimws()
rawtext29 <- pdftext[[19]][29] %>% trimws()
rawtext30 <- pdftext[[19]][30] %>% trimws()
rawtext31 <- pdftext[[19]][31] %>% trimws()
rawtext32 <- pdftext[[19]][32] %>% trimws()
rawtext33 <- pdftext[[19]][33] %>% trimws()
rawtext34 <- pdftext[[19]][34] %>% trimws()
rawtext35 <- pdftext[[19]][35] %>% trimws()
rawtext36 <- pdftext[[19]][36] %>% trimws()
rawtext37 <- pdftext[[19]][37] %>% trimws()
rawtext38 <- pdftext[[19]][38] %>% trimws()
rawtext39 <- pdftext[[19]][39] %>% trimws()
rawtext40 <- pdftext[[19]][40] %>% trimws()
rawtext41 <- pdftext[[19]][41] %>% trimws()
rawtext42 <- pdftext[[19]][42] %>% trimws()
rawtext43 <- pdftext[[19]][43] %>% trimws()
rawtext44 <- pdftext[[19]][44] %>% trimws()
rawtext45 <- pdftext[[19]][45] %>% trimws()
rawtext46 <- pdftext[[19]][46] %>% trimws()
rawtext47 <- pdftext[[19]][47] %>% trimws()
rawtext48 <- pdftext[[19]][48] %>% trimws()
rawtext49 <- pdftext[[19]][49] %>% trimws()
rawtext50 <- pdftext[[19]][50] %>% trimws()
...
# Grab individual text values for Page 1
rawtext1 <- pdftext[[21]][1] %>% trimws()
rawtext2 <- pdftext[[21]][2] %>% trimws()
rawtext3 <- pdftext[[21]][3] %>% trimws()
rawtext4 <- pdftext[[21]][4] %>% trimws()
rawtext5 <- pdftext[[21]][5] %>% trimws()
rawtext6 <- pdftext[[21]][6] %>% trimws()
rawtext7 <- pdftext[[21]][7] %>% trimws()
rawtext8 <- pdftext[[21]][8] %>% trimws()
rawtext9 <- pdftext[[21]][9] %>% trimws()
rawtext10 <- pdftext[[21]][10] %>% trimws()
rawtext11 <- pdftext[[21]][11] %>% trimws()
rawtext12 <- pdftext[[21]][12] %>% trimws()
rawtext13 <- pdftext[[21]][13] %>% trimws()
rawtext14 <- pdftext[[21]][14] %>% trimws()
rawtext15 <- pdftext[[21]][15] %>% trimws()
rawtext16 <- pdftext[[21]][16] %>% trimws()
rawtext17 <- pdftext[[21]][17] %>% trimws()
rawtext18 <- pdftext[[21]][18] %>% trimws()
rawtext19 <- pdftext[[21]][19] %>% trimws()
rawtext20 <- pdftext[[21]][20] %>% trimws()
rawtext21 <- pdftext[[21]][21] %>% trimws()
rawtext22 <- pdftext[[21]][22] %>% trimws()
rawtext23 <- pdftext[[21]][23] %>% trimws()
rawtext24 <- pdftext[[21]][24] %>% trimws()
rawtext25 <- pdftext[[21]][25] %>% trimws()
rawtext26 <- pdftext[[21]][26] %>% trimws()
rawtext27 <- pdftext[[21]][27] %>% trimws()
rawtext28 <- pdftext[[21]][28] %>% trimws()
rawtext29 <- pdftext[[21]][29] %>% trimws()
rawtext30 <- pdftext[[21]][30] %>% trimws()
rawtext31 <- pdftext[[21]][31] %>% trimws()
rawtext32 <- pdftext[[21]][32] %>% trimws()
rawtext33 <- pdftext[[21]][33] %>% trimws()
rawtext34 <- pdftext[[21]][34] %>% trimws()
rawtext35 <- pdftext[[21]][35] %>% trimws()
rawtext36 <- pdftext[[21]][36] %>% trimws()
rawtext37 <- pdftext[[21]][37] %>% trimws()
rawtext38 <- pdftext[[21]][38] %>% trimws()
rawtext39 <- pdftext[[21]][39] %>% trimws()
rawtext40 <- pdftext[[21]][40] %>% trimws()
rawtext41 <- pdftext[[21]][41] %>% trimws()
rawtext42 <- pdftext[[21]][42] %>% trimws()
rawtext43 <- pdftext[[21]][43] %>% trimws()
rawtext44 <- pdftext[[21]][44] %>% trimws()
rawtext45 <- pdftext[[21]][45] %>% trimws()
rawtext46 <- pdftext[[21]][46] %>% trimws()
rawtext47 <- pdftext[[21]][47] %>% trimws()
rawtext48 <- pdftext[[21]][48] %>% trimws()
rawtext49 <- pdftext[[21]][49] %>% trimws()
rawtext50 <- pdftext[[21]][50] %>% trimws()
