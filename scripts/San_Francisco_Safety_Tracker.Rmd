...
ABC7's data team looked at the San Francisco Police Department's crime incident data by police district from 2020 through `r format(asofdate, "%B %d, %Y")`. Totals here include murders, but not involuntary manslaughter or justifiable homicide.
