...
One way to think about the danger: four years ago, the murder rate was <h8>`r murders_city$rate21`</h8> per 100,000 residents. That's lower than the risk of dying in a vehicle crash in California. The rate has changed to <h8>`r murders_city$rate_last12`</h8> in the last 12 months.
<br>
<br>
