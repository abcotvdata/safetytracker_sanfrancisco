...
The city averaged about <h8>`r round(murders_city$last12mos/12,0)`</h8> homicides a month over the last 12 months. In 2021, that number was about <h8>`r round(murders_city$total21/12,0)`</h8> a month.

One way to think about the danger: four years ago, the murder rate was <h8>`r murders_city$rate21`</h8> per 100,000 residents. That's lower than the risk of dying in a vehicle crash in California. The rate has risen slightly to <h8>`r murders_city$rate_last12`</h8> in the last 12 months.
<br>
<br>
...
ABC7's data team looked at the San Francisco Police Department's crime incident data by police district from 2021 through `r format(asofdate, "%B %d, %Y")`. Totals here include murders, but not involuntary manslaughter or justifiable homicide.
