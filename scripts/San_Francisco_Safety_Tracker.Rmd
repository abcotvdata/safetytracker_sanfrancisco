...
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_23tolast12>=0," up"," down")` `r ifelse(murders_city$inc_23tolast12>=0,murders_city$inc_23tolast12,substring(murders_city$murders_city$inc_23tolast12,2))`%</h8> when compared to last year, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.
