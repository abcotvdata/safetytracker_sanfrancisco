...
<br>
Homicides over the last 12 months are trending <h8>`r case_when(murders_city$inc_21tolast12 >= .25 ~ " up", murders_city$inc_21tolast12<=-.25 ~ " down", TRUE ~ " about the same")`</h8> when compared to 2021, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.

The murder rate over the last 12 months is <h8>`r case_when((murders_city$rate_last12-murders_city$rate_prior3years)>=0.25 ~ "up",
...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's far lower than the risk of dying in a vehicle crash in California. The rate has risen slightly to <h8>`r murders_city$rate_last12`</h8> in the last 12 months.
<br>
<br>
