...
<br>
Homicides over the last 12 months are trending <h8>`r case_when(murders_city$inc_22tolast12 >= .25 ~ " up", murders_city$inc_22tolast12<=-.25 ~ " down", TRUE ~ " about the same")`</h8> when compared to 2021, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.
...
The murder rate over the last 12 months is <h8>`r case_when((murders_city$rate_last12-murders_city$rate_prior4years)>=0.25 ~ "up",
          ...
          TRUE ~ "about the same ")`</h8> compared to the annual average over the last four years, and the frequency of killings remains higher than it was before the pandemic.
