...
sf_crime <- cbind(sf_crime_2021,sf_crime_2022, sf_crime_2023, sf_crime_2024)
...
sf_crime$last12mos <- sf_crime$ytd+(sf_crime$total24-sf_crime$prior)
...
citywide_yearly <- right_join(citywide_yearly,yearly_archive %>% select(1:21,23),by="category") %>% select(1,8:28,2:7)
