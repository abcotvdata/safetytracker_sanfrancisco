...
pdftext <- pdf_text("data/source/sf/annual/2021yearend.pdf") %>% strsplit(split = "\n")
...
names(past_crime_all) <- c("category","total2020_rev","total2021","district")

# save 2021 annual file and rds archive
saveRDS(past_crime_all, "scripts/sf/rds/sf_crime_2021.rds")
