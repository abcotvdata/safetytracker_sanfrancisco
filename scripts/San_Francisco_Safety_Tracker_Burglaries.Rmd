...
<subhead>A closer look at San Francisco burglaries neighborhood by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
san_francisco_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
