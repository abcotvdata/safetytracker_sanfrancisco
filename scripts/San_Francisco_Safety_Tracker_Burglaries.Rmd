...
<bignumber>`r prettyNum(round(burglaries_city$avg_prior4years,0), big.mark=",")`<br></bignumber><p>
...
<bignumber>`r round(burglaries_city$rate_prior4years,0)`<br></bignumber><p>
Per 100,000 people<br>2020 to 2023</p>
</div>
</div>
<br>
Burglaries over the last 12 months are <h8>`r ifelse(burglaries_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(burglaries_city$inc_prior4yearavgtolast12>=0,burglaries_city$inc_prior4yearavgtolast12,substring(burglaries_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.

The city averaged <h8>`r round(burglaries_city$last12mos/52,0)`</h8> burglaries a week over the last 12 months. In 2020, that number was <h8>`r round(burglaries_city$total20/52,0)`</h8> a week.
...
The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's data by neighborhood from 2020 through `r format(asofdate, "%B %d, %Y")`.
...
"</td>
				...
				<td>",
round(burglaries_district$avg_prior4years,0),
"</td>
				<td>",
round(burglaries_district$rate_prior4years,0),
"</td>
			</tr>
</table>")
...
<br>
<br>
<iframe title="Burglary clearance rate year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-SFXzz" src="https://datawrapper.dwcdn.net/SFXzz/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="538" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
