...
The city averaged <h8>`r prettyNum(round(thefts_city$last12mos/52,0), big.mark=",")`</h8> thefts a week over the last 12 months. In 2020, that number was <h8>`r prettyNum(round(thefts_city$total20/52,0), big.mark=",")`</h8> a week.
