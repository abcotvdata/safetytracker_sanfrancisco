...
<bignumber>`r round(autothefts_city$rate_prior4years,0)`<br></bignumber><p>
...
The city averaged <h8>`r round(autothefts_city$last12mos/52,0)`</h8> stolen vehicles a week over the last 12 months. In 2020, that number was <h8>`r round(autothefts_city$total20/52,0)`</h8> a week.
...
<iframe title="Vehicle thefts year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-Uat0Y" src="https://datawrapper.dwcdn.net/Uat0Y/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<iframe title="Vehicle theft clearance rate year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-pFzUz" src="https://datawrapper.dwcdn.net/pFzUz/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="538" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
