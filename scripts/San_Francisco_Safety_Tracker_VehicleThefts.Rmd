...
The city averaged <h8>`r round(autothefts_city$last12mos/52,0)`</h8> stolen vehicles a week over the last 12 months. In 2021, that number was <h8>`r round(autothefts_city$total21/52,0)`</h8> a week.
