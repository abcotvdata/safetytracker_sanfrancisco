...
<subhead>A closer look at San Francisco vehicle thefts by neighborhood</subhead>
...
san_francisco_autotheft_map <- leaflet(autothefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
