...
<h2>ABC7 is tracking crime and safety across the San Francisco and in your neighborhood. 
...
<bignumber>`r prettyNum(round(sexassaults_city$avg_prior4years,0), big.mark=",")`<br></bignumber><p>
...
<bignumber>`r sexassaults_city$rate_prior4years`<br></bignumber><p>
Per 100,000 people<br>2020 to 2023</p>
</div>
</div>
<br>
Sexual assaults over the last 12 months are <h8>`r ifelse(sexassaults_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(sexassaults_city$inc_prior4yearavgtolast12>=0,sexassaults_city$inc_prior4yearavgtolast12,substring(sexassaults_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to San Francisco Police Department data through `r format(asofdate, "%B %d")`.

The city averaged <h8>`r round(sexassaults_city$last12mos/52,0)`</h8> sexual assaults a week over the last 12 months. In 2020, that number was <h8>`r round(sexassaults_city$total20/52,0)`</h8> a week.

<subhead>A closer look at San Francisco sexual assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's public data about sexual assault reports by neighborhood from 2020 through `r format(asofdate, "%B %d, %Y")`.
...
"</td>
				...
				<td>",
sexassaults_district$avg_prior4years,
"</td>
				<td>",
sexassaults_district$rate_prior4years,
"</td>
			</tr>
</table>")
...
<iframe title="Sexual Assaults year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-Fm0Lg" src="https://datawrapper.dwcdn.net/Fm0Lg/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<iframe title="Sexual assault clearance rate year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-IbUo1" src="https://datawrapper.dwcdn.net/IbUo1/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="538" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
