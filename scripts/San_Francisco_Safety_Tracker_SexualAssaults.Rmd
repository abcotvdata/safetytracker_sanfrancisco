...
The city averaged <h8>`r round(sexassaults_city$last12mos/52,0)`</h8> sexual assaults a week over the last 12 months. In 2021, that number was <h8>`r round(sexassaults_city$total21/52,0)`</h8> a week.

<subhead>A closer look at San Francisco sexual assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's public data about sexual assault reports by neighborhood from 2021 through `r format(asofdate, "%B %d, %Y")`.
