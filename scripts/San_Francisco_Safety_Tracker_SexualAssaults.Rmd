...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC7 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_bayarea/raw/main/docs/banner_kgo.png)
...
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_SexualAssaults.html">Sexual Assaults</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_Batteries.html">Batteries</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_VehicleThefts.html">Vehicle Thefts</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_Burglaries.html">Burglaries</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker.html">Homicides</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_Robberies.html">Robberies</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_SexualAssaults.html">Sexual Assaults</option>
<option value="https://abcotvdata.github.io/safetytracker_bayarea/San_Francisco_Safety_Tracker_Thefts.html">Thefts</option>
</select></h2>
<select onchange="window.location=this.value"><h2>Choose a different Bay Area city to explore: <select onchange="window.location=this.value">
...
The figures included here are for cases San Francisco police classify as "criminal sexual assault," which includes any forcible rape - or attempted rape - of any person regardless of age or gender.

<subhead>A closer look at San Francisco sexual assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the San Francisco Police Department's public data about sexual assault reports by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
san_francisco_sexassault_map <- leaflet(sexassaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
